...
public class PrmchkEntListController {
    ...
    public void populateData(){
		...
		ArrayList<String> feedingsSystems=account.getFeedingsSystems();
		
		if(feedingsSystems!=null && feedingsSystems.size()>0){
			...
			for(String system:feedingsSystems){
				if(!system.equals("")){
					TreeItem<String> feedSystemItem = new TreeItem<String>(system);
					feedSystemItem.setExpanded(true);
					populateFeedSystem(system,feedSystemItem);
					root.getChildren().add(feedSystemItem);
				}
			}
	...
	public void populateFeedSystem(String feedingSystem,TreeItem<String> root){

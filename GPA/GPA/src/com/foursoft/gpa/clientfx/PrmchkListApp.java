...
import com.foursoft.gpa.clientfx.controller.PrmchkListController;

public class PrmchkListApp extends Application {
	
	public static final String VIEW_FXML = "PrmchkList.fxml";
	private String feedingSystem;
	
	private PrmchkListController controller;
	
	public PrmchkListApp(String feedingSystem) {
	...
	public Node getNode(){
		...
		try {
			...
			controller.setFeedingSystem(feedingSystem);
